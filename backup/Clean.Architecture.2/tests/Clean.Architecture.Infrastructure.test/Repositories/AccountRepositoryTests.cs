...
namespace Clean.Architecture.Tests.Repositories
{
    public class AccountRepositoryTests
    {
        ...
        public AccountRepositoryTests()
        {
            ...
            _accountRepository = new AccountRepository(_configurationMock.Object, _dbConnectionWrapperMock.Object, _loggerMock.Object);
        }
        ...
        //}
        [Fact]
        public async Task AddAsync_ShouldReturnTrue_WhenAccountIsAddedSuccessfully()
        {
            // Arrange
            var account = new Account();
            _dbConnectionWrapperMock.Setup(x => x.ExecuteAsync(It.IsAny<string>(), It.IsAny<Account>())).ReturnsAsync(1);
